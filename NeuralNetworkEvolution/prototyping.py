...
# %% ../nbs/prototyping.ipynb 15
@eqx.filter_value_and_grad()
def compute_loss(params, x, y):
    preds = jax.vmap(params)(x)
    return jnp.mean((preds - y) ** 2)

# %% ../nbs/prototyping.ipynb 16
@eqx.filter_jit
