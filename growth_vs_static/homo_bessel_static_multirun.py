...
Description = f"Homo_{act_string}_bessel_static_{optimizer.__name__}_bias_{max_neurons}_{hidden_sizes[0]}_{hidden_sizes[1]}_{num_epochs}_{start_seed}_{NUM_RUNS}"
