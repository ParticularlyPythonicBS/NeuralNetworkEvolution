...
Description = f"Homo_{act_string}_bessel_deterministic_addition_{optimizer.__name__}_bias_min_{min_neurons}_max_{max_neurons}_{hidden_sizes[0]}_{hidden_sizes[1]}_{num_epochs}_{intervene_every}_{start_seed}_{NUM_RUNS}"
