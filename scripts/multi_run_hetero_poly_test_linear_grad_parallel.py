...
Description = f"Hetero_poly_test_linear_grad_strat__no_bias_{hidden_sizes[0]}_{hidden_sizes[1]}_{num_epochs}_{intervene_every}_{threshold}_runs_{NUM_RUNS}"
...
if __name__ == "__main__":
    with multiprocessing.Pool() as pool:
        pool.map(run_expt, range(NUM_RUNS))
